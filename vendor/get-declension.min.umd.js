!(function (e, t) {
    ...
    for (var l in o)
      if (e(o, l)) {
        var g = o[l],
          ...
          h = g.validator,
          x = n[l],
          q = !!e(g, "required") && ("function" == typeof v ? v(n) : v),
          m = e(n, l),
          w = h(x, n);
        if (q) {
          if (!m) throw new TypeError(c(l + " is required."));
          if (!w)
            throw new TypeError(
              c(
                "Expected " +
  ...
  function r(e) {
    throw new TypeError([i, e, n].join(" "));
  }
  var f = {
      optionConfig: {
        required: !0,
        validator: function (o) {
          for (var i in o)
            if (e(o, i)) {
              ...
              if (
                ...
                e(n, "default") ||
                  r(
                    "Expected optionConfig." +
                      i +
                      " to either have required or default value."
                  );
              if (
                (e(n, "default") ||
                  e(n, "required") ||
              ...
              } else r("Missing description on optionConfig." + i + " config.");
              if (e(n, "validator")) {
                var d = n.validator;
              ...
              } else r("Missing validator on optionConfig." + i + " config.");
            }
          return t(o);
        },
  ...
  return function (e) {
    var t = (function (e) {
        var t = o({ optionConfig: f, userOptions: e, preffix: i, suffix: n });
        return o(t);
      })({
        optionConfig: a,
        userOptions: e,
      ...
      d = t.few,
      p = t.many;
    if (Math.round(r) !== r) p = d;
    else {
      var c = Math.abs(r % 10),
        s = Math.abs(r % 100);
      1 === c && 11 !== s
        ? (p = u)
        : 2 <= c && c <= 4 && (s < 10 || 20 <= s) && (p = d);
    }
    return r + " " + p;
  };
});
